...
class Sparks(PooledEffect, EffectController):
    ...
    def createTrack(self):
        ...
        self.startEffect = Sequence(Func(self.p0.setBirthRate, 0.0050000000000000001), Func(self.p0.setPoolSize, 32), Func(self.p0.clearToInitial), Func(self.f.start, self, self.particleDummy), Func(self.f.reparentTo, self))
