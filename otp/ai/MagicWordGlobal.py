...
CATEGORY_GAME_DEVELOPER = MagicWordCategory('Game development commands', 500)
CATEGORY_ADMINISTRATION = MagicWordCategory('Administration commands', 600)
CATEGORY_SYSTEM_ADMINISTRATION = MagicWordCategory('System administration commands', 700)
